 ...
 * @author Asus
 */
public class forgot_teacher extends javax.swing.JFrame {

    /**
     * Creates new form forgot_teacher
     */
    public forgot_teacher() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Teacher Portal Forgot Password");
        setResizable(false);
        ...
        jLabel4.setText("Teacher Forgot Password");
    ...
    private void getpass_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getpass_buttonActionPerformed
        ...
        try{
            ...
            if(id.equals("Ansarul Islam"))
            {
                JOptionPane.showMessageDialog(this, "Your Password is: 1234");
            }
            else
            {
                JOptionPane.showMessageDialog(this, "Your Password not found...!");
            }
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(this, "Please enter correct form of your Username.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(forgot_teacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new forgot_teacher().setVisible(true);
            }
        });
    }
