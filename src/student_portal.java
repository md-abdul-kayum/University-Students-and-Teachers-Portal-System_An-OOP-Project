...
public class student_portal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(1100, 770));
    ...
    private void login_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_buttonActionPerformed
        ...
        try{
        if(userName.equals("201002334") && passWord.equals("kaiyum334"))
        {
             close();
             home_portal hom = new home_portal();
             hom.setVisible(true);
        }
        else if(userName.equals("201002324") && passWord.equals("hasib324"))
        {
             close();
